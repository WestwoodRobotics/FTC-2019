...
public class AutonCommand {
    ...
    public static void turnOnWheelRight(DcMotor leftMotor, DcMotor rightMotor, float desiredAngle, Telemetry telemetry){
        ...
        // set left motor to run to target encoder position and stop with brakes on.
        leftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        // set right motor to run wit n     hout regard to an encoder.
    ...
    public static void turnOnCenterRight(DcMotor leftMotor, DcMotor rightMotor, float desiredAngle, Telemetry telemetry)
    {
        rightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        leftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        rightMotor.setTargetPosition(rotateTicks(desiredAngle)*3/2);
        leftMotor.setTargetPosition(rotateTicks(desiredAngle) * 3/2
        );
        ...
        // set both motors to 25% power. Movement will start.
        while (Math.abs(rightMotor.getCurrentPosition()) < rotateTicks(desiredAngle)*3/2) {
            telemetry.addData("Fraction of Turn: ", Math.abs(rightMotor.getCurrentPosition() / rotateTicks(desiredAngle)));
            telemetry.addData("Fraction of Turn: ", Math.abs(rightMotor.getCurrentPosition()));
            telemetry.addData("Fraction of Turn: ", rotateTicks(desiredAngle));
            telemetry.addData("f",x);
    ...
    public static void moveBackward(DcMotor leftMotor, DcMotor rightMotor, double desiredInches,Telemetry telemetry){
        leftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        rightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    ...
    public static void turnOnCenterLeft(DcMotor leftMotor, DcMotor rightMotor, float desiredAngle, Telemetry telemetry)
    {
        rightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        leftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
